                         ...
                         GdkColor     *color)
{
    ...
    color->pixel = 0;
    color->red   = CLAMP ((guint16)(rgba.red   * 65535. + 0.5), 0, 65535);
    color->green = CLAMP ((guint16)(rgba.green * 65535. + 0.5), 0, 65535);
    color->blue  = CLAMP ((guint16)(rgba.blue  * 65535. + 0.5), 0, 65535);
}
