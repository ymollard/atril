...
compare_mappings (EvMapping *a, EvMapping *b)
{
	...
	return ABS (dy) > 10 ? (int)(dy + 0.5) : (int)(dx + 0.5);
}
				...
				AtkCoordType coord_type)
{
	...
	*x = (int)(atk_rect.x1 + 0.5);
	*y = (int)(atk_rect.y1 + 0.5);
	*width = (int)(atk_rect.x2 - atk_rect.x1 + 0.5);
	*height = (int)(atk_rect.y2 - atk_rect.y1 + 0.5);
}
