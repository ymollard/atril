		     ...
		     EvRenderContext *rc)
{
	...
	required_width = (int)((dvi_document->base_width * rc->scale) + 0.5);
	required_height = (int)((dvi_document->base_height * rc->scale) + 0.5);
	proposed_width = (int)((dvi_document->context->dvi_page_w * dvi_document->context->params.conv) + 0.5);
	proposed_height = (int)((dvi_document->context->dvi_page_h * dvi_document->context->params.vconv) + 0.5);
				       ...
				       gboolean 	     border)
{
	...
	mdvi_set_shrink (dvi_document->context,
			  (int)((dvi_document->base_width * dvi_document->params->hshrink / thumb_width) + 0.5),
			  (int)((dvi_document->base_height * dvi_document->params->vshrink / thumb_height) + 0.5));
...
dvi_document_do_color_special (DviContext *dvi, const char *prefix, const char *arg)
{
        if (strncmp (arg, "pop", 3) == 0) {
			...
			parse_color (tmp + 4, rgb, 3);
                        ...
                        red   = (guchar)(255 * rgb[0]);
                        green = (guchar)(255 * rgb[1]);
                        blue  = (guchar)(255 * rgb[2]);
			...
			red   = (guchar)(r * 255 + 0.5);
			green = (guchar)(g * 255 + 0.5);
			blue  = (guchar)(b * 255 + 0.5);
			...
			mdvi_push_color (dvi, RGB2ULONG (rgb, rgb, rgb), 0xFFFFFFFF);
				...
				red   = (guchar)(color.red * 255 / 65535.);
				green = (guchar)(color.green * 255 / 65535.);
				blue  = (guchar)(color.blue * 255 / 65535.);
